package com.goinhn.leetcode._1_100._51_60;
...
//            开始回溯恢复原有的字符
    ...
    public static void main(String[] args) {
        Solution_51_1 solution_51_1 = new Solution_51_1();
        solution_51_1.solveNQueens(4);
        for (List<String> list : solution_51_1.result) {
            for (String s : list) {
